...
class scraptbl(scrapy.Spider):
    ...
    def parse(self, response):
        tableheader =   '//div[@id="ctl00_ContentPlaceHolder1_ctl02_UpdatePanel1"]//\
                        div[@class="panel panel-default"]//div[@class="table-responsive"]//\
                        table[@class="table table-hover table-heatmap"]//thead//tr'

        tablevalues =   '//div[@id="ctl00_ContentPlaceHolder1_ctl02_UpdatePanel1"]//\
                        div[@class="panel panel-default"]//div[@class="table-responsive"]//\
                        table[@class="table table-hover table-heatmap"]//tr'
        ...
        for sel in response.xpath(tablevalues):
            ...
            datalist = str(datacountry)+","+str(last)+","+str(previous)+","+str(date_time)
